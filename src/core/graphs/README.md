...
- (Optional) `modular_output_display.py`: Modular plotting functions (spine snapshots, fin/tail timelines, head orientation, etc.)
...
For a deep dive into the data flow from enriched CSV to plotting, see:

- [docs/data_transfer_pipeline.md](docs/data_transfer_pipeline.md)
